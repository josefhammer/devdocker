...
# /home/devd/dev.
#
# (c) 2022-2024 Josef Hammer
# 
# Source: https://github.com/josefhammer/devdocker

#!/bin/bash
NAME=devdocker
RUNFILE=run-$NAME.sh
DOCKERFILE=https://raw.githubusercontent.com/josefhammer/devdocker/main/Dockerfile
BUILDFILE=build-devdocker.sh
BUILDSRC=https://raw.githubusercontent.com/josefhammer/devdocker/main/$BUILDFILE
...
then
    ...
    #
    docker run -v \$(pwd):/home/devd/dev "\$@" --hostname $NAME --init --name $NAME -it $NAME
fi
